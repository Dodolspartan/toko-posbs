						...
						<div class="col-sm-12">
							<div class="panel panel-primary">
								<div class="panel-heading">
									...
									<a class="btn btn-warning pull-right" style="margin-top:-12px;" href="fungsi/hapus/hapus.php?penjualan=jual">
										<h6 style="font-family:poppins; font-weight: 300px;"><i class="fa fa-shopping-cart"></i> Riset Keranjang</h6></a>
									</h4>
								</div>
								<div class="panel-body">
									<div id="keranjang">
